...
//$db_table = "SportsEvents";

# This script is used to parse the sports information from the black bear
# sports webpage.
$sportsArr = array("bsb");
//$sportsArr = array("m-basebl", "m-baskbl", "m-footbl", "m-hockey", 
//					"w-baskbl", "w-fieldh", "w-hockey", "w-soccer", "w-softbl");
$monthArr = array("BLANK", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec");
$baseSportsURL = "http://athletics.umf.maine.edu/";
$urlForm = "http://athletics.umf.maine.edu/sports/%s/%s/schedule";
...
function AddEventIfNotPresent ($dt, $h, $rl, $r, $s, $ta, $tb, $yr, $mdt)
{
	...
	if(!$isPresent){
		...
		// TODO: REMOVE THIS
		print "Sport: " . $s . " team A: " . $ta . " team B: " . $tb . " year range: " . $yr . " modified date time: " . $mdt . "\n";
...
function GetResultsAndRecaps ($dStr)
{
	...
	$sportsAndYears = array("bsb;2010-11");
...
//		$yearRange = $sportAndYearRange[1];
		// TODO: Uncomment the above and remove these two lines
		$sport = "bsb";
		$yearRange = "2010-11";
